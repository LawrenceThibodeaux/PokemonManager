...
public class AddHMMoveDialog extends JDialog {
    private JPanel contentPane;
    private JButton buttonOK;
    private JButton buttonCancel;
    private JComboBox<String> hmMoveSelector;
    private JComboBox<String> pokemonSelector;

    private PokeTrainer trainer;

    public AddHMMoveDialog(final PokeTrainer trainer) {
    ...
    private void onOK() {
        final int targetPokemon = pokemonSelector.getSelectedIndex();
        final HMMove targetMove = HMMove.valueOf((String) hmMoveSelector.getSelectedItem());
        trainer.currentParty().get(targetPokemon).teachHMMove(targetMove);
    ...
    public void showDialog() {
        populatePokemonSelector(trainer, pokemonSelector);
        for (final HMMove move : HMMove.values()) {
            hmMoveSelector.addItem(move.name());
        }
        this.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        hmMoveSelector = new JComboBox();
        panel3.add(hmMoveSelector, new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label1 = new JLabel();
        label1.setText("Pokemon");
        ...
        panel3.add(pokemonSelector, new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
